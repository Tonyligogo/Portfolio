...
function Skills() {
  return (
    <div className="py-10 bg-gradient-to-r from-sky-50 via-blue-100 to-blue-200">
      <h1 className="text-center text-3xl font-bold mb-10">My Core Skills</h1>
      <ul className="grid grid-cols-5 gap-y-6 justify-center w-1/2 mx-auto gap-3 ">
        <li className="bg-white border grid place-content-center size-28 rounded-md">
        ...
        <li className="bg-white border grid place-content-center size-28 rounded-md">
          <img src={TailwindIcon} alt="tailwind logo" className="w-24" />
        </li>
        <li className="bg-white border grid place-content-center size-28 rounded-md">
        ...
        <li className="bg-white border grid place-content-center size-28 rounded-md">
          <img src={DjangoIcon} alt="tailwind logo" className="w-24" />
        </li>
      </ul>
    </div>
  );
